...
- 🔍 **智能搜索** - 支持 codepoint、英文名、中文名搜索（3,690 个命名 emoji，100% 覆盖）
- 📝 **Emoji 名字** - 每个 emoji 下方显示名字，跟随语言设置切换
- 📄 **分页浏览** - 可配置每页数量（20/50/100/200/500/1000/2000/3500/4000）
- 🌍 **中英文切换** - 自动检测浏览器语言，支持手动切换
- 🔤 **大小写切换** - 直观显示 "ABC"/"abc" 状态
- 🎨 **Vercel 风格** - 简洁的黑白配色 + 蓝色强调
- 📱 **响应式设计** - 完美适配移动端和桌面端
- 💾 **偏好记忆** - 自动保存大小写风格、分页设置和语言偏好
